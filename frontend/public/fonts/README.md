...
Chatty 排版（Typst）使用以下字体，均来自可再分发来源：

| 文件 | 来源 | 许可 |
|---|---|---|
| MiSans-Regular.otf / MiSans-Bold.otf | 小米 MiSans（汉仪字库）| 免费商用（可嵌入分发），Copyright © Xiaomi / Hanyi |
...
MiSans 许可与下载：https://hyperos.mi.com/font
